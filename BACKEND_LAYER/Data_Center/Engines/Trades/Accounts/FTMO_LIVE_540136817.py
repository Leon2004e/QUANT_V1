# -*- coding: utf-8 -*-
"""
QUANT_OS/BACKEND_LAYER/Data_Center/Engines/Trades/FTMO_LIVE_540136817.py
...
# CODE_REGISTRY
# ============================================================
# script_id: trade_logger_live_540136817
# script_name: Trade Logger LIVE 540136817
# owner: Leon Everts
# status: active
# layer: 1_Pipeline
# domain: Trades
# asset_type: Pipeline
# purpose: Logs MT5 closed trades and current open-position state into SQLite for account 540136817.
# inputs:
...
CODE_REGISTRY: Dict[str, object] = {
    ...
    "reviewer": "ChatGPT",
    "created_date": "2026-06-01",
    "account_login_default": "540136817",
    "account_type_expected": "LIVE",
    "mt5_server_default": "FTMO-Server4",
    "terminal_exe_default": r"C:\Users\Leon\Desktop\Terminals\MetaTrader 5 - Kopie - Kopie - Kopie (11) - Kopie - Kopie - Kopie - Kopie\terminal64.exe",
    "tags": [
        "mt5",
        "trades",
        "closed_trades",
...
FIXED_TERMINAL_EXE = Path(
    r"C:\Users\Leon\Desktop\Terminals\MetaTrader 5 - Kopie - Kopie - Kopie (11) - Kopie - Kopie - Kopie - Kopie\terminal64.exe"
)

MT5_LOGIN = int(os.getenv("MT5_LOGIN", "540136817"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "?wviT5wa4AH!2E")
