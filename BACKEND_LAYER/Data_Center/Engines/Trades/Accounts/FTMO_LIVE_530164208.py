# -*- coding: utf-8 -*-
"""
QUANT_OS/BACKEND_LAYER/Data_Center/Engines/Trades/FTMO_LIVE_530164208.py
...
# CODE_REGISTRY
# ============================================================
# script_id: trade_logger_live_530164208
# script_name: Trade Logger LIVE 530164208
# owner: Leon Everts
# status: active
# layer: 1_Pipeline
# domain: Trades
# asset_type: Pipeline
# purpose: Logs MT5 closed trades and current open-position state into SQLite for account 530164208.
# inputs:
...
CODE_REGISTRY: Dict[str, object] = {
    ...
    "reviewer": "ChatGPT",
    "created_date": "2026-06-01",
    "account_login_default": "530164208",
    "account_type_expected": "LIVE",
    "mt5_server_default": "FTMO-Server3",
    "terminal_exe_default": r"C:\Users\Leon\Desktop\Terminals\MetaTrader 5 - Kopie - Kopie - Kopie (19) - Kopie - Kopie - Kopie - Kopie - Kopie\terminal64.exe",
    "tags": [
        "mt5",
        "trades",
        "closed_trades",
...
FIXED_TERMINAL_EXE = Path(
    r"C:\Users\Leon\Desktop\Terminals\MetaTrader 5 - Kopie - Kopie - Kopie (19) - Kopie - Kopie - Kopie - Kopie - Kopie\terminal64.exe"
)

MT5_LOGIN = int(os.getenv("MT5_LOGIN", "530164208"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "9G8z5i!lanq7")
