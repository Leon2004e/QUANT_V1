# -*- coding: utf-8 -*-
"""
QUANT_OS/BACKEND_LAYER/Data_Center/Engines/Trades/FTMO_DEMO_2.py
...
# CODE_REGISTRY
# ============================================================
# script_id: trade_logger_demo_1513550380
# script_name: Trade Logger DEMO 1513550380
# owner: Leon Everts
# status: active
# layer: 1_Pipeline
# domain: Trades
# asset_type: Pipeline
# purpose: Logs MT5 closed trades and current open-position state into SQLite for demo account 1513550380.
# inputs:
...
CODE_REGISTRY: Dict[str, object] = {
    ...
    "reviewer": "ChatGPT",
    "created_date": "2026-06-01",
    "account_login_default": "1513550380",
    "account_type_expected": "DEMO",
    "mt5_server_default": "FTMO-Demo",
    "terminal_exe_default": r"C:\Users\Leon\Desktop\Terminals\MetaTrader 5 - Kopie - Kopie - Kopie (17) - Kopie - Kopie - Kopie - Kopie\terminal64.exe",
    "tags": [
        "mt5",
        "trades",
        "closed_trades",
